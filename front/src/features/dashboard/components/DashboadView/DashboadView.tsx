...
// Local components
import DashboardErrorState from './DashboadErrorState'
import DashboardSkeleton from './DashboadSkeleton'
      ...
      <div className={styles.statsGrid}>
        <article className={styles.card}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.description}>Browse all rooms and open their weekly schedules.</p>
          </div>
        ...
        <article className={styles.card}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.description}>Review your future reservations and manage them.</p>
          </div>
