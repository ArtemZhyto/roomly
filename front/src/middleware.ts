...
export async function middleware(req: NextRequest): Promise<NextResponse> {
  ...
  if (accessToken) {
    return isPublicRoute ? redirectTo(req, '/') : NextResponse.next()
  }
  ...
  try {
    ...
    const response = isPublicRoute ? redirectTo(req, '/') : NextResponse.next()
